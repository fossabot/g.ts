...
tape('easeBounceIn(t) coerces t to a number', function(test) {
  ...
  test.strictEqual(ease.easeBounceIn({valueOf() { return 0.9; }}), ease.easeBounceIn(0.9));
  test.end();
});

tape('easeBounceOut(t) returns the expected results', function(test) {
  let bounceOut = generic.out(ease.easeBounceIn);
...
tape('easeBounceOut(t) coerces t to a number', function(test) {
  ...
  test.strictEqual(ease.easeBounceOut({valueOf() { return 0.9; }}), ease.easeBounceOut(0.9));
  test.end();
});

tape('easeBounceInOut(t) returns the expected results', function(test) {
  let bounceInOut = generic.inOut(ease.easeBounceIn);
...
tape('easeBounceInOut(t) coerces t to a number', function(test) {
  ...
  test.strictEqual(ease.easeBounceInOut({valueOf() { return 0.9; }}), ease.easeBounceInOut(0.9));
  test.end();
});
