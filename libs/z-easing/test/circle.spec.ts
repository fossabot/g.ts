...
tape('easeCircleIn(t) coerces t to a number', function(test) {
  ...
  test.strictEqual(ease.easeCircleIn({valueOf() { return 0.9; }}), ease.easeCircleIn(0.9));
  test.end();
});

tape('easeCircleOut(t) returns the expected results', function(test) {
  let circleOut = generic.out(ease.easeCircleIn);
...
tape('easeCircleOut(t) coerces t to a number', function(test) {
  ...
  test.strictEqual(ease.easeCircleOut({valueOf() { return 0.9; }}), ease.easeCircleOut(0.9));
  test.end();
});

tape('easeCircleInOut(t) returns the expected results', function(test) {
  let circleInOut = generic.inOut(ease.easeCircleIn);
...
tape('easeCircleInOut(t) coerces t to a number', function(test) {
  ...
  test.strictEqual(ease.easeCircleInOut({valueOf() { return 0.9; }}), ease.easeCircleInOut(0.9));
  test.end();
});
